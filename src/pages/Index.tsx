...
const Index = () => {
  ...
  return <div className={`min-h-screen transition-all duration-500 ${isDarkMode ? 'bg-gradient-to-br from-gray-900 via-purple-900 to-violet-900' : 'bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900'}`}>
      {/* Navigation */}
      <Navigation />
        ...
        <div className="relative container mx-auto px-6 py-20 lg:py-32">
          <div className="text-center space-y-8">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight">
              Generate Stunning
              <span className="block bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent italic animate-pulse hover:scale-110 transition-all duration-100 cursor-default">
                AI Images
              </span>
              in Seconds
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
              <Button onClick={() => navigate("/auth")} className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-6 text-lg rounded-xl shadow-2xl transform hover:scale-105 transition-all duration-300" size="lg">
                Get Started Free
                <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
              
              <Button variant="outline" className="bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 hover:from-emerald-600 hover:via-teal-600 hover:to-cyan-600 text-white border-0 px-8 py-6 text-lg rounded-xl shadow-2xl transform hover:scale-105 transition-all duration-300" size="lg">
                View Gallery
              </Button>
            </div>
          </div>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button onClick={toggleTheme} className={`w-14 h-14 rounded-full ${isDarkMode ? 'bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600' : 'bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700'} text-white shadow-2xl transform hover:scale-110 transition-all duration-300`} size="icon">
